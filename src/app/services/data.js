const servicesData = {
  "civil-engineering": {
    ...
    imagehero: "/images/civil/hero.jpg",
    subtitle:
    ...
    expertise: [
      {
        ...
        desc: "Comprehensive engineering of civil systems.",
      },
      {
        title: "Project Lifecycle Management",
        desc: "Coordination of budgets, schedules, and quality control.",
      },
    ],
    images: {
      main: "/images/civil/main.jpg",
      gallery: ["/images/civil/gallery-1.jpg", "/images/civil/gallery-2.png"],
    },
    relatedServices: [
      {
  ...
  "electrical-engineering": {
    title: "Electrical Engineering",
    imagehero: "/images/electrical/hero.webp",
    subtitle:
    ...
    images: {
      main: "/images/electrical/main.jpg",
      gallery: [
        "/images/electrical/gallery-1.jpg",
        "/images/electrical/gallery-2.webp",
      ],
    },
    relatedServices: [
      {
  ...
  "material-management-and-logistics": {
    ...
    imagehero: "/images/material/hero.jpg",
    subtitle:
    ...
    expertise: [
      {
        ...
        desc: "Real-time tracking and stock forecasting to prevent shortages.",
      },
      {
        title: "Global Freight Coordination",
        desc: "Seamless import/export handling with customs compliance.",
      },
    ],
    images: {
      main: "/images/material/main.webp",
      gallery: [
        "/images/material/gallery-1.jpg",
        "/images/material/gallery-2.jpeg",
      ],
    },
    relatedServices: [
      {
  ...
  "janitorial-and-fumigation": {
    ...
    imagehero: "/images/janitorial/hero.webp",
    subtitle:
    ...
    expertise: [
      {
        ...
        desc: "High-grade cleaning routines certified by health authorities.",
      },
      {
        title: "Eco-Safe Fumigation",
        desc: "Targeted pest control without environmental harm.",
      },
    ],
    images: {
      main: "/images/janitorial/main.jpg",
      gallery: [
        "/images/janitorial/gallery-1.jpg",
        "/images/janitorial/gallery-2.jpg",
      ],
    },
    relatedServices: [
      {
  ...
  "canteen-and-cafeteria": {
    ...
    imagehero: "/images/canteen/hero.jpg",
    subtitle:
    ...
    expertise: [
      {
        title: "Nutrition-Focused Meal Planning",
        desc: "Balanced menus designed for employee health.",
      },
      {
        title: "Sustainability Management",
        desc: "Waste reduction strategies and eco-conscious sourcing.",
      },
    ],
    images: {
      main: "/images/canteen/main.jpg",
      gallery: [
  ...
  "building-and-renovation": {
    title: "Building and Renovation",
    imagehero: "/images/building/hero.jpeg",
    subtitle:
    ...
    expertise: [
      {
        title: "Multi-Disciplinary Repair Work",
        desc: "Civil, electrical, and plumbing maintenance under one roof.",
      },
      {
        title: "Interior & Exterior Renovation",
        desc: "Painting, flooring, and structural updates with modern finishes.",
      },
    ],
    images: {
      main: "/images/building/main.jpg",
      gallery: [
        "/images/building/gallery-1.jpeg",
  ...
  "perimeter-security": {
    title: "Perimeter Security",
    imagehero: "/images/perimeter/hero.jpg",
    subtitle:
    ...
    expertise: [
      {
        title: "Defense-Grade Barrier Systems",
        desc: "High-resistance fencing solutions for critical infrastructure.",
      },
      {
        title: "Site-Specific Installation",
        desc: "Customized designs based on terrain and threat level.",
      },
    ],
    images: {
      main: "/images/perimeter/main.jpg",
      gallery: [
        "/images/perimeter/gallery-1.jpg",
        "/images/perimeter/gallery-2.jpeg",
      ],
    },
    relatedServices: [
      {
  ...
  "solar-energy": {
    title: "Solar Energy",
    imagehero: "/images/solar/hero.webp",
    subtitle:
    ...
    expertise: [
      {
        ...
        desc: "Customized solar designs for reliable renewable power.",
      },
      {
        title: "Hybrid Integration",
        desc: "Seamless incorporation with existing energy systems and battery backups.",
      },
    ],
    images: {
      main: "/images/solar/main.webp",
      gallery: ["/images/solar/gallery-1.jpg", "/images/solar/gallery-2.webp"],
    },
    relatedServices: [
      {
        title: "Electrical Engineering",
  ...
  "mechanical-engineering": {
    title: "Mechanical Engineering",
    imagehero: "/images/mechanical/hero.webp",
    subtitle:
    ...
    expertise: [
      {
        ...
        desc: "Climate control solutions for commercial and industrial spaces.",
      },
      {
        title: "Plumbing & Fluid Handling",
        desc: "Efficient design and installation for water and waste systems.",
      },
    ],
    images: {
      main: "/images/mechanical/main.jpg",
      gallery: [
        "/images/mechanical/gallery-1.jpg",
        "/images/mechanical/gallery-2.jpg",
      ],
    },
    relatedServices: [
      {
  ...
  "import-export": {
    ...
    imagehero: "/images/import/hero.jpg",
    subtitle:
    ...
    expertise: [
      {
        ...
        desc: "Managing import/export permits and customs documentation.",
      },
      {
        title: "Global Procurement Networks",
        desc: "Access to certified international suppliers and freight solutions.",
      },
    ],
    images: {
      main: "/images/import/main.jpg",
      gallery: ["/images/import/gallery-1.jpg", "/images/import/gallery-2.jpg"],
    },
    relatedServices: [
      {
  ...
  "human-resource": {
    ...
    imagehero: "/images/human/hero.webp",
    subtitle:
    ...
    expertise: [
      {
        ...
        desc: "Competency-based selection processes and thorough background checks.",
      },
      {
        title: "Learning & Development Programs",
        desc: "Tailored training modules and ongoing performance support.",
      },
    ],
    images: {
      main: "/images/human/main.jpg",
      gallery: ["/images/human/gallery-1.webp", "/images/human/gallery-2.webp"],
    },
    relatedServices: [
      {
        title: "Canteen & Cafeteria Services",
  ...
  "security-and-training": {
    ...
    imagehero: "/images/security/hero.webp",
    subtitle:
    ...
    expertise: [
      {
        ...
        desc: "Access control, CCTV, and alarm technologies for physical security.",
      },
      {
        title: "Professional Security Training",
        desc: "Certified courses in emergency response and threat mitigation.",
      },
    ],
    images: {
      main: "/images/security/main.webp",
      gallery: [
        "/images/security/gallery-1.webp",
        "/images/security/gallery-2.jpg",
      ],
    },
    relatedServices: [
      {
